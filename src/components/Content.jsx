...
const Content = () => {
  ...
  return (
  <>
    {/* <div onClick={()=>)className='absolute w-full h-full inset-0 z-0 bg-[#333] '>

    </div> */}
    <Clickedcomponent visible={showClicked}/>
    <div onClick={()=>setShow()} id="main" className='laptop:mx-[7rem] laptop:grid laptop:grid-rows-2 laptop:gap-x-[5rem] laptop:gap-y-[1.3rem]  laptop:children:w-[12.375rem] laptop:children:h-[12.6875rem] laptop:h-[26.875rem] laptop:w-[29.75rem] mobile:gap-x-[5.5rem] mobile:gap-y-[9rem]  mobile:children:w-[8.125rem] mobile:children:h-[8.3125rem]'>
